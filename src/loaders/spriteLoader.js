export default function loadSprites(k) {
  ...
  k.loadSprite("endingCredits", "./assets/images/endcreditbackground.png");
  k.loadSprite("heart-bg", "./assets/images/heart-bg.png");
  k.loadSprite("endingAlone", "./assets/images/endingAlone.png");
  k.loadSprite("endingYuki", "./assets/images/endingYuki.png");
  k.loadSprite("endingSatoshi", "./assets/images/endingSatoshi.png");
  k.loadSprite("endingKoji", "./assets/images/endingKoji.png");
  k.loadSprite("endingMari", "./assets/images/endingMari.png");
  k.loadSprite("endingNaoko", "./assets/images/endingNaoko.png");
  k.loadSprite("endingHana", "./assets/images/endingHana.png");
  k.loadSprite("endingOldman", "./assets/images/endingOldman.png");
  k.loadSprite("instructions", "./assets/images/instructions.png");
  ...
  // Sunset Background
  k.loadSprite("sunset", "./assets/images/sunset.png",{
  sliceX: 4,
  anims: {
